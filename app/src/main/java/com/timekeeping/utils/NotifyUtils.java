...
public final class NotifyUtils {
	...
	public static void notifyWithoutBigImage( Context cxt,
											  int id,
											  String title,
											  String desc,
		...
		mgr.notify(
				id,
				buildNotifyWithoutBigImage( cxt,
											id,
											title,
											desc,
											icon,
	...
	public static Notification buildNotifyWithoutBigImage( Context cxt,
														   int id,
														   String title,
														   String desc,
														   @DrawableRes int icon,
		...
		Builder builder = new Builder( cxt ).setWhen( id )
											.setSmallIcon( icon )
											.setTicker( title )
											.setContentTitle( title )
											.setContentText( desc )
											.addAction(
													R.drawable.ic_app_rating,
													cxt.getString( R.string.btn_app_rating ),
													getAppPlayStore( cxt )
											)
											.setStyle( new BigTextStyle().bigText( desc )
	...
	public static PendingIntent getAppPlayStore( Context cxt ) {
		...
		return PendingIntent.getActivity(
				cxt,
				com.chopping.utils.Utils.randInt(
						1,
						9999
				),
				intent,
