...
public final class VolumeDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		return new AlertDialog.Builder(getActivity()).setTitle(R.string.lbl_vol).setView(layout)
				.setCancelable(true).setPositiveButton(R.string.save_label, new DialogInterface.OnClickListener() {
